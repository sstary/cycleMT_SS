...
def train_opts(parser):
    ...
    group.add_argument('-save_model', default='experiments/checkpoints/MIT_mixed_augm/MIT_mixed_augm_model',
                       help="""Model filename (the model will be saved as
                       <save_model>_N.pt where N is the number
                       of steps""")

    group.add_argument('-save_checkpoint_steps', type=int, default=1,
    ...
    group.add_argument('-valid_batch_size', type=int, default=4,
    ...
    group.add_argument('-learning_rate', type=float, default=2.0,
    ...
    group.add_argument('-warmup_steps', type=int, default=8000,
                       help="""Number of warmup steps for custom decay.""")

    group = parser.add_argument_group('Logging')
    group.add_argument('-report_every', type=int, default=1,
    ...
    group.add_argument('-tensorboard', action="store_true", default=True,
...
def translate_opts(parser):
    ...
    group.add_argument('-output', default='experiments/results/getF_2.txt',
